  ...
  return (
    ...
    >
      <button
        ...
        onClick={() => {
          if (index > 0) {
            ...
            setIndex(Math.max(0, itemsCount - visibleItemsCount));
          }
        }}
      >
        <ChevronLeft
      ...
      <button
        ...
        onClick={() => {
          if (index < itemsCount - visibleItemsCount) {
            setIndex(index + 1);
          } else {
            setIndex(0);
          }
...
function CarouselContent({
  ...
  const onDragEnd = () => {
    ...
    if (x <= -10) {
      setIndex(index < itemsLength - visibleItemsCount ? index + 1 : 0);
    } else if (x >= 10) {
      setIndex(index > 0 ? index - 1 : Math.max(0, itemsLength - visibleItemsCount));
    }
  };
